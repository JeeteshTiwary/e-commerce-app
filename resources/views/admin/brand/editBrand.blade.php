...
<div id="kt_app_content_container" class="app-container container-xxl">
    <form id="kt_ecommerce_add_Brand_form" class="form d-flex flex-column flex-lg-row" action="{{ route('brand.update', encrypt($brand->id)) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <!--begin::Aside column-->
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    ...
                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                        ...
                        <div class="image-input-wrapper w-150px h-150px" style="background-image:url({{ asset('brands/logos') . '/' . $brand->logo }});"></div>
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    <!--begin::Select2-->
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_Brand_status_select" name="status">
                        <option></option>
                    ...
                    <div class="d-none mt-10">
                        ...
                        <input class="form-control" id="kt_ecommerce_add_Brand_status_datepicker" placeholder="Pick date & time" />
                    </div>
                    <!--end::Datepicker-->
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <!--end::Label-->
                    <!--begin::Select2-->
                    <select class="form-select mb-2" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple" name="categories[]">
                        <option></option>
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="mb-10 fv-row">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="text" name="name" class="form-control mb-2" placeholder="Brand name" value="{{ $brand->name }}" />
                        <!--end::Input-->
                        <!--begin::Description-->
                    ...
                    <div>
                        ...
                        <!--end::Label-->
                        <!--begin::Editor-->
                        <div id="kt_ecommerce_add_Brand_description" name="kt_ecommerce_add_Brand_description" class="min-h-100px mb-2">
                            <textarea id="description" name="description" rows="4" cols="35">{{ $brand->description }}. </textarea>
                        </div>
                        <!--end::Editor-->
                        <!--begin::Description-->
                    ...
                    <div>
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input type="url" name="url" class="form-control mb-2" placeholder="brand url" value="{{ $brand->url }}" />
                        <!--end::Input-->
                        <!--begin::Description-->
            ...
            <div class="d-flex justify-content-end">
                <!--begin::Button-->
                <a href="{{ route('brand.index') }}" id="kt_ecommerce_add_Brand_cancel" class="btn btn-light me-5">Cancel</a>
                <!--end::Button-->
                <!--begin::Button-->
