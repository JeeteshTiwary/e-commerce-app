...
<div id="kt_app_content_container" class="app-container container-xxl">
    <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" action="{{ route('category.update', encrypt($category->id)) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <!--begin::Aside column-->
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body text-center pt-0">
                    ...
                    <div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
                        ...
                        <div class="image-input-wrapper w-150px h-150px" style="background-image:url({{ asset('categories/thumbnails') . '/' . $category->thumbnail }});">
                        </div>
                        ...
                        <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change thumbnail">
                            ...
                            <!--end::Icon-->
                            <!--begin::Inputs-->
                            <input type="file" name="thumbnail" value="{{ $category->thumbnail }}" accept=".png, .jpg, .jpeg" />
            ...
            <div class="card card-flush py-4">
                ...
                <div class="card-body pt-0">
                    ...
                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_store_Parent Category" name="parent_id">
                        ...
                        <option value="{{ $data->id }}" {{ $data->id == $category->parent_id ? 'selected' : null }}>{{ $data->name }}
                        </option>
                        @endforeach
                ...
                <div class="card-body pt-0">
                    ...
                    <div>
                        ...
                        <div id="kt_ecommerce_add_category_description" name="kt_ecommerce_add_category_description" class="min-h-100px mb-2">
                            <textarea id="description" name="description" rows="4" cols="35">{{ $category->description }}. </textarea>
                        </div>
                        <!--end::Editor-->
                        <!--begin::Description-->
