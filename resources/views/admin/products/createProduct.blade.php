...
<div id="kt_app_content_container" class="app-container container-xxl">
    <!--begin::Form-->
    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html" method="POST" action="{{ route('product.store') }}" enctype="multipart/form-data">
        @csrf
        @method('POST')
        <!--begin::Aside column-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="base_price" class="form-control mb-2" placeholder="Product base price" value="{{old('base_price')}}" />
                                    <!--end::Input-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="sale_price" class="form-control mb-2" placeholder="Product sale price" value="{{old('sale_price')}}" />
                                    <!--end::Input-->
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <div class="d-flex gap-3">
                                        <input type="number" name="quantity_on_shelf" class="form-control mb-2" placeholder="Quantity on shelf" value="{{old('quantity_on_shelf')}}" />
                                        <span class="text-danger"> {{ $errors->first('quantity_on_shelf') }} </span>
                                    </div>
                                    <div class="d-flex gap-3">
                                        <input type="number" name="quantity_in_warehouse" class="form-control mb-2" placeholder="Quantity in warehouse" value="{{old('quantity_in_warehouse')}}" />
