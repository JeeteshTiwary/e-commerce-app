...
<script>
    var ENDPOINT = "{{ route('category.index') }}"; // This will be processed by Blade
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="mx-5 d-flex">
                                ...
                                <div class="ms-5">
                                    <!--begin::Title-->
                                    <a href="{{ route('category.show', encrypt($category->id)) }}" class="text-gray-800 text-hover-primary fs-5 fw-bold mb-1" data-kt-ecommerce-category-filter="category_name"> {{ $category->name }}
                                    </a>
                                    <!--end::Title-->
                                    <!--begin::Description-->
